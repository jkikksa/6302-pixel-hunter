import {Settings, AnswerType} from './settings';
...
const getScore = (answers, remainingLives) => {
  ...
  score = answers.reduce((acc, it) => {
    ...
    acc.bonusCount += it.type === AnswerType.FAST ? 1 : 0;
    acc.penaltyCount += it.type === AnswerType.SLOW ? 1 : 0;
    return acc;
  }, {
    answersScore: 0,
    bonusCount: 0,
  ...
  score.livesCount = remainingLives < 0 ? 0 : remainingLives;
